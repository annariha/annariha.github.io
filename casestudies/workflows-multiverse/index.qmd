...
![Bayesian Workflow in [@gelmanetal2020]](bayesworkflow-illu.png){#fig-bw-gelman height="5%"}

![Bayesian Workflow in [@martinetal2021].](workflow-bayescompbook.png){#fig-bw-martin width="90%"}
...
![Multiverse analysis compared to other approaches, from [@dragicevic2019].](images/multiverse-illu.png){#fig-mvd width="60%"}

::: {layout-ncol="2" layout-valign="top"}
![What is a multiverse analysis report? in [@halletal2022].](multiverse-def.png){#fig-mvhall width="50%"}

![Multiverse analysis in Bayesian workflow in [@gelmanetal2020].](multiverse-in-bw.png){#fig-mvbw width="30%"}
:::
